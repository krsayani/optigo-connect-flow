...
const TITLE = "How It Works | LensFlow Connected Optical Workflow";
const DESC =
  "Connect, route, track, communicate: how LensFlow moves optical order information between practices, EHR systems, laboratories, and patients.";
  ...
  return (
    <>
      <PageHero
        ...
        body="Optical order information moves from the practice or EHR into LensFlow, through the appropriate laboratory workflow, and back to the practice and patient as the order progresses."
      >
