...
const TITLE = "Platform | LensFlow Optical Workflow Infrastructure";
const DESC =
  "The LensFlow platform is a connectivity and automation layer between optometry practices, EHR systems, optical laboratories, and patients.";
