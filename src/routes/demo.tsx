...
const TITLE = "Request a Demo | LensFlow";
const DESC =
  "See how LensFlow is being built to connect your practice, EHR system, and optical laboratories through one streamlined optical ordering workflow.";
  ...
  return (
    <>
      <PageHero
        ...
        title={
          <>
            See LensFlow <span className="text-gradient">in action.</span>
          </>
        }
            ...
            <div className="rounded-2xl border border-border bg-mist p-6">
              ...
              <ul className="mt-4 space-y-3 text-sm text-navy/85">
                {[
                  ...
                  "A walkthrough of the LensFlow platform experience being built",
