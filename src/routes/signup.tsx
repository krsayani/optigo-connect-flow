...
const TITLE = "Sign Up | LensFlow for Practices & Labs";
const DESC =
  "Create your LensFlow account as an optometry practice or optical laboratory and start connecting optical workflows.";
...
const labPerks = [
  ...
  "Connect once to practices on LensFlow",
];
        ...
        <div className="relative mx-auto max-w-7xl">
          <Reveal className="max-w-3xl">
            ...
            <h1 className="mt-4 font-display text-4xl font-extrabold leading-[1.05] tracking-[-0.04em] text-navy sm:text-5xl lg:text-[3.5rem]">
              Sign up for <span className="text-gradient">LensFlow</span>
            </h1>
            ...
            <Reveal delay={120} className="space-y-4">
              ...
              <div className="rounded-3xl border border-electric/20 surface-dark p-6 sm:p-7">
                ...
                <p className="mt-2 text-sm leading-relaxed text-on-dark-muted">
                  Please do not include patient health information. LensFlow is being built with
