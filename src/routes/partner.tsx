...
const TITLE = "Partner With LensFlow | Integration Partnerships";
const DESC =
  "Optical laboratories, EHR and practice-management providers, and technology partners: connect with the LensFlow integrations team.";
