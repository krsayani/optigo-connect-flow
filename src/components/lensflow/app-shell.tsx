  ...
  return (
    <div className="lf-app font-sans">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="sticky top-0 z-30 flex flex-wrap items-center gap-2.5 border-b border-hairline bg-background/80 px-4 py-2.5 pt-[max(0.65rem,env(safe-area-inset-top))] backdrop-blur-xl sm:px-5">
          ...
          <form
            className="flex h-9 min-w-[140px] flex-1 items-center gap-2 rounded-xl border border-border bg-mist/70 px-3 max-w-md"
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button
                type="button"
                className="ml-auto inline-flex items-center gap-2 rounded-full border border-border bg-background py-1 pl-1 pr-2.5 text-left shadow-sm outline-none transition-colors hover:border-electric/35 focus-visible:ring-2 focus-visible:ring-electric"
                aria-label="Account menu"
              >
                <span className="grid h-7 w-7 place-items-center rounded-full bg-navy font-display text-[11px] font-bold text-primary-foreground">
        ...
        <nav
          className="flex gap-1 overflow-x-auto border-t border-hairline bg-background/90 px-2 py-1.5 pb-[max(0.4rem,env(safe-area-inset-bottom))] backdrop-blur-xl md:hidden"
          aria-label="OptiGo"
        >
          {TABS.map((item) => (
            <NavButton
  ...
  return (
    <button
      ...
      className={cn(
        ...
        variant === "mobile" &&
          cn(
            "min-w-[4.5rem] flex-1 flex-col gap-1 rounded-xl px-2 py-1.5 text-[10px] font-semibold",
